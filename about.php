	...
	<div class="container">
    	...
    	<div id="primary-nav" class="header-right">
            ...
            <ul class="sf-menu">
                ...
                <li><a href="./ended.php">Ended Auctions</a></li>
                <li><a href="./about.php">About Us</a></li>	                
             </ul>
        </div>
        
        <!-- LOGO -->        
    	<a href="./index.php"><img src="./images/logo.png" border="0" alt="Auction House NITK" /></a>
...
<div class="container">
    ...
    <br class="clear" /><br />
	  <p style="font-size: 20px">Auction House NITK brings to you a great chance to buy an sell your stuffs easily. </p>
	   <p style="font-size: 20px"><br />
	    Features:<br />
    1. Users can view products that are for auction uploaded by other users. <br/>
    2. Users can view and bid for a product multiple times before the deadline.
     <br />
	       </p>
      <p>&nbsp;</p>
       <p style="font-size: 20px">Once the deadline for a product is met the user with the highest bid should be given an option to “Claim” the item.<br /></p>
      <p>&nbsp;</p>
       <p style="font-size: 20px">
        You can win as many items as you want! That's the beauty of this site!</p>
    </div>
