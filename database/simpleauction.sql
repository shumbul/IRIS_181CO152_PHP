/*
 ...
 Source Database       : simpleauction.sql
...
-- ----------------------------
BEGIN;
INSERT INTO `admin` VALUES ('1', 'iris', 'password');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', 'iris', 'NITK','password','sample_address','sample_postal','me@gmail.com','1234','10,'date');
COMMIT;
